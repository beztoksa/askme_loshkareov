...
(() => {
    ...
    var le = (o, s, e, t) => {
        if (s && typeof s == "object" || typeof s == "function") for (let n of ae(s)) !ue.call(o, n) && n !== e && B(o, n, {
            get: () => s[n],
    ...
    var z = he((Pe, U) => {
        ...
        Object.defineProperty(h, "defaultMaxListeners", {
            enumerable: !0, get: function () {
                ...
                if (typeof o != "number" || o < 0 || F(o)) throw new RangeError('The value of "defaultMaxListeners" is out of range. It must be a non-negative number. Received ' + o + ".");
                H = o
            }
        });
        h.init = function () {
        ...
        h.prototype.setMaxListeners = function (s) {
            if (typeof s != "number" || s < 0 || F(s)) throw new RangeError('The value of "n" is out of range. It must be a non-negative number. Received ' + s + ".");
        ...
        h.prototype.emit = function (s) {
            ...
            if (typeof c == "function") q(c, this, e); else for (var u = c.length, _ = Y(c, u), t = 0; t < u; ++t) q(_[t], this, e);
            return !0
        };

        function K(o, s, e, t) {
            var n, i, r;
            if (C(e), i = o._events, i === void 0 ? (i = o._events = Object.create(null), o._eventsCount = 0) : (i.newListener !== void 0 && (o.emit("newListener", s, e.listener ? e.listener : e), i = o._events), r = i[s]), r === void 0) r = i[s] = e, ++o._eventsCount; else if (typeof r == "function" ? r = i[s] = t ? [e, r] : [r, e] : t ? r.unshift(e) : r.push(e), n = V(o), n > 0 && r.length > n && !r.warned) {
                r.warned = !0;
        ...
        h.prototype.removeListener = function (s, e) {
            var t, n, i, r, a;
            if (C(e), n = this._events, n === void 0) return this;
                    ...
                    start(v) {
                        function E() {
                            return _.read().then(({done: b, value: l}) => {
                                ...
                                try {
                                    if (s._protocol === "json") for (a += s._utf8decoder.decode(l); c < a.length;) if (a[c] === `
`) {
...
`) throw new Error("size integer not terminated by '\\n'");
        ...
        for (; t.haveBytes();) {
            ...
            switch (t.getChar()) {
                case"@":
                    if (u = t.getInt(), t.haveBytes() && t.getChar() !== ",") throw new Error("copy command not terminated by ','");
                    if (e += c, e > r) throw new Error("copy exceeds output file size");
                    if (u + c > n) throw new Error("copy extends past end of input");
                    a.putArray(o, u, u + c);
                    break;
                case":":
                    if (e += c, e > r) throw new Error("insert command gives an output larger than predicted");
                    if (c > i) throw new Error("insert count exceeds size of delta");
                    a.putArray(t.a, t.pos, t.pos + c), t.pos += c;
                    break;
                case";": {
                    let _ = a.toByteArray(o);
                    if (c !== Te(_)) throw new Error("bad checksum");
                    if (e !== r) throw new Error("generated size does not match predicted size");
                    return _
                }
                default:
...
`).map(e => JSON.parse(e))
        ...
        applyDeltaIfNeeded(s, e) {
            ...
            } else t = JSON.parse(s.data), n = new TextEncoder().encode(s.data);
    ...
    var se = J(z()), we = {
        ...
        history(e, t) {
            ...
            return this._methodCall().then(function () {
                return i._callPromise(n, function (r) {
                    let a = r.history, c = [];
                    if (a.publications) for (let u = 0; u < a.publications.length; u++) c.push(i._getPublicationContext(e, a.publications[u]));
        ...
        _initializeTransport() {
            ...
            if (this._config.readableStream !== null ? r = this._config.readableStream : typeof globalThis.ReadableStream < "u" && (r = globalThis.ReadableStream), this._emulation) {
                ...
                let l = 0;
                for (; ;) {
                    if (l >= this._transports.length) throw new Error("no supported transport found");
                    ...
                    } else throw new Error("unknown transport " + d);
                    break
                }
            } else {
                if ($(this._endpoint, "http")) throw new Error("Provide explicit transport endpoints configuration in case of using HTTP (i.e. using array of TransportEndpoint instead of a single string), or use ws(s):// scheme in an endpoint if you aimed using WebSocket transport");
            ...
            b = setTimeout(function () {
                ...
                onOpen: function () {
                    ...
                    if (l && "code" in l && l.code && (f = l.code), l && l.reason) try {
        ...
        _startReconnecting() {
            ...
            this._getToken().then(function (i) {
                ...
                e.emit("error", {type: "connectToken", error: {code: 5, message: i !== void 0 ? i.toString() : ""}});
